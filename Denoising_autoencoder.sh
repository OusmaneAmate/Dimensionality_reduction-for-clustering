...
def add_noise(X, noise_factor=0.2):
    ...
    """
    X_noisy = X + noise_factor * np.random.normal(loc=0.0, scale=2.0, size=X.shape)
...
def denoising_autoencoder_reduction(X, n_components, noise_factor=0.2):
    try:
        ...
        plt.legend()
        plt.savefig(f'/home/ousmane/results/Plot_loss_curve_denoising_gaussian.png')
        plt.show()
...
def main():
    ...
    output_path = '/home/ousmane/results/Plot_clustering_denoising_gaussian.png'
