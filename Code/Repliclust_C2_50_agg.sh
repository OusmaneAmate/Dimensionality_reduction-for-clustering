...
folder_path = '/home/ousmane/D50_K2'
...
def main():
    ...
    df_ari_per_file.to_csv("ari_scores_repliclust_C2D50_agglomerative.csv")
    ...
    fig.show()
    output_path = '/home/ousmane/results/Plot_clustering_agg_vae_repliclust_C2_50D.png'
