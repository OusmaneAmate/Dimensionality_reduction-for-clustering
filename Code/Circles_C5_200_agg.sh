...
folder_path = '/home/ousmane/Make_circles_C5_200Features'
...
def process_file(file_path):
    ...
    try:
        ...
        Agg = AgglomerativeClustering(n_clusters=5, linkage='complete',metric='cosine')
        ...
        def process_reduction(method, n_components):
            ...
            try:
                ...
                Agg_reduced = AgglomerativeClustering(n_clusters=5, linkage='complete',metric='cosine')
...
def main():
    ...
    df_ari_per_file.to_csv("ari_scores_circles_C5D200_agglomerative.csv")
    ...
    fig.show()
    output_path = '/home/ousmane/results/Plot_clustering_agg_vae_circles_C5_200D.png'
