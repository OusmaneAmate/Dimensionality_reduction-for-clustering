    ...
    try:
        ...
        def process_reduction(method, n_components):
            ...
            try:
                ...
                y_pred = Gm_reduced.fit_predict(X_reduced)
...
def main():
    ...
    df_ari_per_file.to_csv("ari_scores_circles_C5D200_gaussian.csv")
    ...
    fig.show()
    output_path = '/home/ousmane/results/Plot_clustering_gm_vae_circles_C5_200D.png'
