...
folder_path = '/home/ousmane/Make_circles_C2_200Features'
...
def process_file(file_path):
    ...
    try:
        ...
        Agg = AgglomerativeClustering(n_clusters=2, linkage='average', metric='manhattan')
        ...
        def process_reduction(method, n_components):
            ...
            try:
                ...
                Agg_reduced = AgglomerativeClustering(n_clusters=2, linkage='average', metric='manhattan')
                y_pred = Agg_reduced.fit_predict(X_reduced)
...
def main():
    ...
    df_ari_per_file.to_csv("ari_scores_circles_C2D200_agglomerative.csv")
    ...
    fig.show()
    output_path = '/home/ousmane/results/Plot_clustering_agg_vae_circles_C2_200D.png'
