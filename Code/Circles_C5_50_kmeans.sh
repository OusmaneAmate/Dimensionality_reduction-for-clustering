...
for file_path in csv_files:
    ...
    y_pred_original = kmeans.fit_predict(X_scaled)
    ...
    for method in reduction_methods:
        for n_components in n_components_list:
            ...
            try:
                ...
                kmeans_reduced = KMeans(n_clusters=5,n_init=100)
                y_pred_reduced = kmeans_reduced.fit_predict(X_reduced)
...
df_ari_per_file.to_csv("ari_scores_circles_C5D50_kmeans.csv")
...
fig.update_layout(
    ...
    bargap=0.5,
    bargroupgap=0.7,
    title='ARI Scores for Kmeans Clustering with and without Dimensionality Reduction',
...
# Enregistrer l'image
output_path = '/home/ousmane/results/Plot_clustering_kmeans_vae_circles_C5_50D.png'
