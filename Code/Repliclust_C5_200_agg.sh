...
folder_path = '/home/ousmane/D200_K5'
...
def main():
    ...
    df_ari_per_file.to_csv("ari_scores_repliclust_C5D200_agglomerative.csv")
    ...
    fig.show()
    output_path = '/home/ousmane/results/Plot_clustering_agg_vae_repliclust_C5_200D.png'
