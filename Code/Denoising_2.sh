...
def denoising_autoencoder_reduction(X, n_components, noise_factor=0.2):
    try:
        ...
        plt.legend()
        plt.savefig(f'/home/ousmane/results/Plot_loss_curve_denoising_agglomerative.png')
        plt.show()
...
def main():
    ...
    output_path = '/home/ousmane/results/Plot_clustering_denoising_agglomerative.png'
