    ...
    for method in reduction_methods:
        for n_components in n_components_list:
            ...
            try:
                ...
                Agg_reduced = AgglomerativeClustering(n_clusters=2, linkage='ward', metric='euclidean')
...
df_ari_per_file.to_csv("ari_scores_circles_C2D10_agglomerative.csv")
...
# Enregistrer l'image
output_path = '/home/ousmane/results/Plot_clustering_agg_vae_circles_C2_10D.png'
