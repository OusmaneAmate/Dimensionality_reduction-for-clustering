...
folder_path = '/home/ousmane/Make_moons_C5_200Features'
...
def main():
    ...
    df_ari_per_file.to_csv("ari_scores_moons_C5D200_agglomerative.csv")
    ...
    fig.show()
    output_path = '/home/ousmane/results/Plot_clustering_agg_vae_moons_C5_200D.png'
