...
folder_path = '/home/ousmane/Make_circles_C5_50Features'
...
for file_path in csv_files:
    ...
    Agg = AgglomerativeClustering(n_clusters=5, linkage='ward',metric='euclidean')
    ...
    for method in reduction_methods:
        for n_components in n_components_list:
            ...
            try:
                ...
                Agg_reduced = AgglomerativeClustering(n_clusters=5, linkage='ward',metric='euclidean')
...
df_ari_per_file.to_csv("ari_scores_circles_C5D50_agglomerative.csv")
...
# Enregistrer l'image
output_path = '/home/ousmane/results/Plot_clustering_agg_vae_circles_C5_50D.png'
