...
extraction_dir = '/home/ousmane/C10_200Features/'
...
def vae_autoencoder_reduction(X, n_components):
    try:
        ...
        plt.legend()
        plt.savefig(f'/home/ousmane/results/Plot_loss_curve_optics_vae.png')
        plt.show()
...
def main():
    ...
    output_path = '/home/ousmane/results/Plot_clustering_optics_vae.png'
