    ...
    for method in reduction_methods:
        for n_components in n_components_list:
            ...
            try:
                ...
                Gm_reduced = GaussianMixture(n_components=2,covariance_type = "full")
...
df_ari_per_file.to_csv("ari_scores_moons_C2D10_gaussian.csv")
...
# Enregistrer l'image
output_path = '/home/ousmane/results/Plot_clustering_gm_vae_moons_C2_10D.png'
