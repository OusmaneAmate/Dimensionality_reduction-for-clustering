...
folder_path = '/home/ousmane/Make_moons_C2_200Features'
...
def process_file(file_path):
    ...
    try:
        ...
        Agg = AgglomerativeClustering(n_clusters=2, linkage='complete', metric='euclidean')
        ...
        def process_reduction(method, n_components):
            ...
            try:
                ...
                Agg_reduced = AgglomerativeClustering(n_clusters=2, linkage='complete', metric='euclidean')
...
def main():
    ...
    df_ari_per_file.to_csv("ari_scores_moons_C2D200_agglomerative.csv")
    ...
    fig.show()
    output_path = '/home/ousmane/results/Plot_clustering_agg_vae_moons_C2_200D.png'
