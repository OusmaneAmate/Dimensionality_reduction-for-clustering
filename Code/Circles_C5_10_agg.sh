...
folder_path = '/home/ousmane/Make_circles_C5_10Features'
...
for file_path in csv_files:
    ...
    Agg = AgglomerativeClustering(n_clusters=5, linkage='average',metric='manhattan')
    y_pred_original = Agg.fit_predict(X_scaled)
    ...
    for method in reduction_methods:
        for n_components in n_components_list:
            ...
            try:
                ...
                Agg_reduced = AgglomerativeClustering(n_clusters=5, linkage='average',metric='manhattan')
                y_pred_reduced = Agg_reduced.fit_predict(X_reduced)
...
df_ari_per_file.to_csv("ari_scores_circles_C5D10_agglomerative.csv")
...
# Enregistrer l'image
output_path = '/home/ousmane/results/Plot_clustering_agg_vae_circles_C5_10D.png'
