    ...
    try:
        ...
        def process_reduction(method, n_components):
            ...
            try:
                ...
                y_pred = Kmeans_reduced.fit_predict(X_reduced)
...
def main():
    ...
    df_ari_per_file.to_csv("ari_scores_circles_C2D200_kmeans.csv")
    ...
    fig.show()
    output_path = '/home/ousmane/results/Plot_clustering_kmeans_vae_circles_C2_200D.png'
