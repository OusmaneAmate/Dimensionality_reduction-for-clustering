    ...
    try:
        ...
        def process_reduction(method, n_components):
            ...
            try:
                ...
                Agg_reduced = AgglomerativeClustering(n_clusters=2, linkage='ward')
...
def main():
    ...
    df_ari_per_file.to_csv("ari_scores_circles_C2D50_agglomerative.csv")
    ...
    fig.show()
    output_path = '/home/ousmane/results/Plot_clustering_agg_vae_circles_C2_50D.png'
