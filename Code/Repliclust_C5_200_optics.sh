...
def process_file(file_path):
    ...
    try:
        ...
        optics = OPTICS(min_samples=6, xi=0.02, min_cluster_size=0.1)
        ...
        def process_reduction(method, n_components):
            ...
            try:
                ...
                optics_reduced = OPTICS(min_samples=6, xi=0.02, min_cluster_size=0.1)
...
def main():
    ...
    df_ari_per_file.to_csv("ari_scores_repliclust_C5D200_optics.csv")
    ...
    fig.show()
    output_path = '/home/ousmane/results/Plot_clustering_optics_vae_repliclust_C5_200D.png'
