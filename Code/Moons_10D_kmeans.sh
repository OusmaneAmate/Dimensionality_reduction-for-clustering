    ...
    for method in reduction_methods:
        for n_components in n_components_list:
            ...
            try:
                ...
                kmeans_reduced = KMeans(n_clusters=2,n_init=100)
...
df_ari_per_file.to_csv("ari_scores_moons_C2D10_kmeans.csv")
...
# Enregistrer l'image
output_path = '/home/ousmane/results/Plot_clustering_kmeans_vae_moons_C2_10D.png'
