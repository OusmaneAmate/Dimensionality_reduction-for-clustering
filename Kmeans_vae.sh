...
def vae_autoencoder_reduction(X, n_components):
    try:
        ...
        plt.legend()
        plt.savefig(f'/home/ousmane/results/Plot_loss_curve_kmeans_vae.png')
        plt.show()
...
def main():
    ...
    fig.update_layout(
        ...
        title='Mean ARI Scores for Kmeans Clustering with and without Dimensionality Reduction',
    ...
    output_path = '/home/ousmane/results/Plot_clustering_kmeans_vae.png'
